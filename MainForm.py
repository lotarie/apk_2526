...
class Ui_MainForm(object):
    def setupUi(self, MainForm):
        ...
        self.actionWinding_Number.triggered.connect(self.analyzePointAndPositionClick2)
    ...
    def analyzePointAndPositionClick(self):
        ...
        if result != -1:
            ...
            self.Canvas.setHighlightedPolygon(result) 
        else: 
            mb.setText("Point is outside the polygon") 
            self.Canvas.setHighlightedPolygon(-1)
            
        mb.exec()
        
        
    def analyzePointAndPositionClick2(self):
        #Get point
        q = self.Canvas.getQ()
        ...
        if resultWN != -1:
            mb.setText("Point is inside the polygon")
            self.Canvas.setHighlightedPolygon(resultWN) 
        else: 
            mb.setText("Point is outside the polygon") 
            self.Canvas.setHighlightedPolygon(-1)
